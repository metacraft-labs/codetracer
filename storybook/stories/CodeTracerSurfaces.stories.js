...
export const PixelHistory = story("panel", "pixel-history", "populated", "Pixel History");
export const ShaderDebug = story("panel", "shader-debug", "populated", "Shader Debugger");
