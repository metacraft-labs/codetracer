## Host-free build: `std/dynlib` is not linked.
##
...
{.error: "std/dynlib is not linked in the host-free build; route this through src/frontend/viewmodel/platform (NS1, the platform facade)".}
