## Host-free build: `std/browsers` is not linked.
##
...
{.error: "std/browsers is not linked in the host-free build; route this through src/frontend/viewmodel/platform (NS1, the platform facade)".}
