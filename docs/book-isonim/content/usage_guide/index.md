...
*   **To review a change with its recordings attached**, see the
    [**DeepReview**](/deep_review) section: what each changed line did — which
    lines ran, with which values — shown on the diff itself, plus the agent
    handoff.
