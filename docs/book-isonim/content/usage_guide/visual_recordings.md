...
![Frame Viewer showing a visual replay frame and draw-call list](/assets/img/visual_recordings/frame-viewer.png)
...
![Pixel History panel showing recorded writes for a selected pixel](/assets/img/visual_recordings/pixel-history.png)
...
![Shader Debugger panel showing shader source for a selected pixel](/assets/img/visual_recordings/shader-debugger.png)
