...
:::note
The breadcrumb chips described above are distinct from
...
:::note
The Origin Chain Side Panel screenshot for this section is
...
:::note
The animated screencast of the VS Code experience is pending
