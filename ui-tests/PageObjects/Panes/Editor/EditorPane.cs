...
public class EditorPane : TabObject
{
    ...
    /// <summary>
    /// Retrieves omniscient flow values rendered next to a line.
    /// </summary>
    public async Task<IReadOnlyList<string>> FlowParallelValuesAsync(EditorLine line)
    {
        var values = new List<string>();
        var valueLocators = await line.FlowParallelValueElements().AllAsync();
