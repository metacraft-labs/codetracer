...
- **Launcher**
  ...
  - Implementation reference: see `docs/launching-multi-instance.md` for the latest multi-instance startup flow captured from the retired prototype.
- **Page Objects**
...
- **Multi-Instance Launch Guide** (`docs/launching-multi-instance.md`): Step-by-step startup and troubleshooting notes extracted from the retired multi-instance prototype.
