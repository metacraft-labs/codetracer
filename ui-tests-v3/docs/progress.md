...
- **2025-10-20** – Documented the multi-instance launch flow in `docs/launching-multi-instance.md`, capturing the troubleshooting steps that previously lived in the now-retired `ui-tests-startup-example/`. Updated debugging guidance to emphasise shared socket usage and reuse of ProcessUtilities/MonitorUtilities patterns.
