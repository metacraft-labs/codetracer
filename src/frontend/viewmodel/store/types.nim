...
type
  ...
  RecentTraceRecord* = object
    ...
    ##
    ## ``id``       — unique recording identifier (matches
    ##                ``Trace.id`` on the legacy ref-object).  M-REC-2:
    ##                this is now the canonical UUIDv7 recording_id
    ##                (36-char hyphenated form) instead of the legacy
    ##                monotonic integer.
