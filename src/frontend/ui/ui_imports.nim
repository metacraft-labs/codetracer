import
  ...
  ../ services / [event_log_service, debugger_service, editor_service, history_service, flow_service, search_service, shell_service]
...
export event_log_service, debugger_service, editor_service, history_service, flow_service, shell_service
