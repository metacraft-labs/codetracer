...
module RbBigLoremIpusum
  module UI
    # Collection of UI utilities used by the demo dashboard flow.
    ...
    ConsoleDashboard = DashboardToolkit::ConsoleDashboard
    DiffSummaryRenderer = DashboardToolkit::DiffSummaryRenderer
  end
end
